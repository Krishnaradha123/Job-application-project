        ...
        <div className="w-10/12 mx-auto pt-20 pb-8 flex flex-col md:flex-row sm:flex-row space-y-2 justify-start">
          <div className="w-full sm:w-2/5 md:w-3/5 pr-6 flex flex-col space-y-2 pb-6 cursor-default">
            ...
            <a
              ...
              href="mailto:pedamalaya@gmail.com"
            >
              pedamalaya@gmail.com
            </a>
            <span className="font-light">
              Copyright © 2024 <span className="font-normal"> Malaya Ranjan Peda</span>{" "}
              Design.
            </span>
          </div>
          ...
          <div className="w-full sm:w-1/5 md:w-2/5 flex flex-col space-y-2 pb-6">
            ...
            <a
              ...
              href="https://www.instagram.com/digital_malaya/profilecard/?igsh=NHR5eXl3aGowczd0"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              ...
              href="https://www.linkedin.com/in/malaya-ranjan-peda-64775332b/"
              target="_blank"
              rel="noreferrer"
            >
